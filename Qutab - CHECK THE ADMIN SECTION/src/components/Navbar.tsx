    ...
    <div className="sticky top-0 z-50 w-full bg-[#fffbef] border-b-4 border-black">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center size-10 bg-black text-white border-2 border-black shadow-[4px_4px_0px_0px_#000000] hover:animate-spin cursor-pointer">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="hidden md:flex items-center justify-center gap-2 bg-[#bdbef5] h-10 px-6 text-black text-sm font-bold border-2 border-black shadow-[4px_4px_0px_0px_#000000] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_#000000] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none transition-all uppercase hover:bg-[#a7a8ed]"
            title="Admin Panel"
          >
        ...
        <div className="md:hidden bg-[#fffbef] border-t-4 border-black">
          <div className="flex flex-col">
            ...
            <button
              ...
              className="text-black text-sm font-bold uppercase px-6 py-4 bg-[#bdbef5] border-b-2 border-black hover:bg-[#a7a8ed] active:bg-[#a7a8ed] transition-all flex items-center justify-center gap-2"
            >
              <MaterialIcon icon="admin_panel_settings" className="text-[18px]" />
              ADMIN
            </button>
