    ...
    <div className="py-20 bg-white border-b-4 border-black overflow-hidden" id="about">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Image */}
          <div
            className="relative border-4 border-black shadow-[8px_8px_0px_0px_#000000] bg-[#cecd34] p-2"
            data-aos="slide-right"
          >
            <img
              alt="Asian farmer smiling while feeding cattle in a green field"
              className="object-cover w-full h-full border-2 border-black grayscale hover:grayscale-0 transition-all duration-500"
          ...
          <div className="flex flex-col gap-6 pt-10 lg:pt-0" data-aos="slide-left">
            <div className="inline-flex items-center gap-2 text-black font-black uppercase tracking-wide text-lg bg-[#cecd34] w-fit px-3 border-2 border-black shadow-[4px_4px_0px_0px_#000000]">
              Misi Kami
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 mt-4">
              <div
                className="flex flex-col gap-2 p-4 bg-[#fffbef] border-2 border-black shadow-[4px_4px_0px_0px_#000000] hover:bg-[#cecd34] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_#000000] transition-all"
                data-aos="fade-up"
                data-aos-delay="200"
              >
