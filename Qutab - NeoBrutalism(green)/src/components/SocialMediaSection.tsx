...
export default function SocialMediaSection() {
  return (
    <div className="py-20 lg:py-16 bg-[#fffbef] border-b-4 border-black overflow-hidden lg:min-h-[calc(100vh-84px)] lg:flex lg:items-center" id="social-media">
      <div className="mx-auto max-w-[90rem] px-6 lg:px-8">
        <div className="relative bg-[#cecd34] border-4 border-black py-6 md:py-8 px-10 md:px-16 shadow-[12px_12px_0px_0px_#000000]">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-4xl lg:text-6xl font-bold text-black leading-none uppercase tracking-tighter mb-4">
                ...
                <span 
                  ...
                  style={{ textShadow: '2px 2px 0 #cecd34' }}
                >
                  MEDIA KAMI
                </span>
              </h2>
              ...
              <div className="flex flex-wrap gap-3">
                <button className="flex items-center gap-3 bg-black text-white px-6 py-3 font-bold border-2 border-black shadow-[4px_4px_0px_0px_#ffffff] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] transition-all group">
                  <MaterialIcon icon="photo_camera" className="text-2xl group-hover:text-[#cecd34] transition-colors" />
