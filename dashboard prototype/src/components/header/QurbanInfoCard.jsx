...
export default function QurbanInfoCard({ product, onAddToWishlist, isInWishlist }) {
  return (
    <div className="relative w-full max-w-3xl rounded-2xl overflow-hidden shadow-lg mx-auto">
      ...
      {/* ❤️ WISHLIST */}
      <button type="button" onClick={onAddToWishlist} className="absolute top-4 right-4 p-2 rounded-full bg-white/90 hover:bg-white shadow transition">
